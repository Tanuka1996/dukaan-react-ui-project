...
export const NavbarIcon130 = ({ className }) => {
  return (
    <svg
      className={`navbar-icon-130 ${className}`}
      fill="none"
      height="20"
      viewBox="0 0 20 20"
      width="20"
    ...
    >
      <g className="g" clipPath="url(#clip0_10420_877)" opacity="0.8">
        <path
          className="path"
      ...
      <defs className="defs">
        <clipPath className="clip-path" id="clip0_10420_877">
