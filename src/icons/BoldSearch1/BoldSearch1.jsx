...
export const BoldSearch1 = ({ color = "#999999", className }) => {
  return (
    <svg
    ...
    >
      <g className="g" clipPath="url(#clip0_10420_34824)">
        <path
          className="path"
      ...
      <defs className="defs">
        <clipPath className="clip-path" id="clip0_10420_34824">
