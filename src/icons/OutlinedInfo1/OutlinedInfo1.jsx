...
export const OutlinedInfo1 = ({ className }) => {
  return (
    <svg
      className={`outlined-info-1 ${className}`}
      fill="none"
      height="14"
      viewBox="0 0 14 14"
      width="14"
    ...
    >
      <g className="g" clipPath="url(#clip0_0_5817)">
        <path
          className="path"
          clipRule="evenodd"
      ...
      <defs className="defs">
        <clipPath className="clip-path" id="clip0_0_5817">
