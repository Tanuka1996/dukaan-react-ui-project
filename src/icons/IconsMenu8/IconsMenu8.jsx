...
export const IconsMenu8 = ({ className }) => {
  return (
    <svg
      className={`icons-menu-8 ${className}`}
      fill="none"
      height="36"
      viewBox="0 0 36 36"
      width="36"
    ...
    >
      <g className="g" clipPath="url(#clip0_0_1223)">
        <circle className="circle" cx="18" cy="18" fill="#E6E6E6" r="18" />
        <path
          className="path"
      ...
      <defs className="defs">
        <clipPath className="clip-path" id="clip0_0_1223">
