...
export const NameMarketingStateTrue = ({ color = "#4D4D4D", className }) => {
  return (
    <svg
      className={`name-marketing-state-true ${className}`}
      fill="none"
      height="20"
      viewBox="0 0 20 20"
      width="20"
    ...
    >
      <path
        className="path"
        d="M12.1074 2.2909C13.0654 1.7684 14.2333 2.46173 14.2333 3.55287V16.4472C14.2333 17.5383 13.0653 18.2317 12.1074 17.7092L4.04696 13.3125H2.375C1.23591 13.3125 0.3125 12.3891 0.3125 11.25V8.75005C0.3125 7.61096 1.23591 6.68755 2.375 6.68755H4.04692L12.1074 2.2909Z"
        fill={color}
      />
      <path
        className="path"
...
NameMarketingStateTrue.propTypes = {
